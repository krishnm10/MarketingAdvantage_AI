...
def embed_query(query: str) -> list[float]:
    ...
    For BGE models, a specific instruction prefix is required for 
    ...
    # MANDATORY: Add instruction for short query to long passage retrieval
    # Note: Do NOT add this instruction to the documents during ingestion.
    instruction = "Represent this sentence for searching relevant passages: "
    query_with_instruction = f"{instruction}{query}"

    # Use normalize_embeddings=True as required for cosine similarity
    ...
    async with get_async_session() as db:
        ...
        while True:
            ...
            try:
                ...
                log_info("Query embedding generated (with BGE instruction)")
